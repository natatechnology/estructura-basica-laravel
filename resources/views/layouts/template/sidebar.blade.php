<div class="iq-sidebar">
    <div class="iq-navbar-logo d-flex justify-content-between">
        <a href="{{route('dashboard')}}" class="header-logo">
            ...
            <span style="font-size: 18px;"><b>ADESS Cloud</b></span>
        </a>
            ...
            <ul id="iq-sidebar-toggle" class="iq-menu">
                <li class="active">
                    <a href="{{route('dashboard')}}" class="iq-waves-effect"><i
                            class="las la-home iq-arrow-left"></i><span>Escritorio</span></a>
                </li>
                <li aria-expanded="true">
                    <a href="#menu-design" class="iq-waves-effect" data-toggle="collapse" aria-expanded="false"><i
                            class="ri-menu-3-line iq-arrow-left"></i><span>Menu Design</span><i
                    ...
                    <ul id="menu-design" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        ...
                        <li><a href="horizontal-top-menu.html"><i class="ri-text-spacing"></i>Horizontal Top Menu</a>
                        </li>
