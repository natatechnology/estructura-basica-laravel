            ...
            <div class="iq-menu-bt d-flex align-items-center">
                ...
                <div class="iq-navbar-logo d-flex justify-content-between ml-3">
                    <a href="{{route('dashboard')}}" class="header-logo">
                        <img src="{{ asset('assets/images/logo.png') }}" class="img-fluid rounded" alt="">
                        <span>FinDash</span>
                    </a>
                </div>
            </div>
            ...
            <ul class="navbar-list">
                <li class="line-height">
                    <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center">
                        <img src="{{ asset('assets/images/user/03.jpg') }}" class="img-fluid rounded mr-3" alt="user">
                        <div class="caption">
                    ...
                    <div class="iq-sub-dropdown iq-user-dropdown">
                        <div class="iq-card shadow-none m-0">
                            <div class="iq-card-body p-0 ">
                                ...
                                <a href="{{route('profile.show')}}" class="iq-sub-card iq-bg-primary-hover">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body ml-3">
                                            ...
                                            <p class="mb-0 font-size-12">Ver los detalles de mi cuenta.</p>
                                        </div>
                                    </div>
                                </a>
                                <a href="#" class="iq-sub-card iq-bg-primary-hover">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body ml-3">
                                            <h6 class="mb-0 ">Mesa de ayuda</h6>
                                            <p class="mb-0 font-size-12">Enlace de contacto con soporte técnico.</p>
                                        </div>
                                    </div>
                                </a>
                                <div class="d-inline-block w-100 text-center p-3">
                                    <a class="bg-primary iq-sign-btn" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" role="button">
